...
namespace GH_RFEM
{
    public class Line_Write : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            String OutputMessage = WriteRfemData(RfemNodesInput);

            // Finally assign the spiral to the output parameter.
            DA.SetData(0, OutputMessage);
        }

        private String WriteRfemData(List<Dlubal.RFEM5.Node> RfemNodesInMethod)
        {
            ...
            try
            {
                ...
                for (int index = 0; index < RfemNodesInMethod.Count; index++)

                {
                    ...
                    //RfemNodeDlubal = RfemNodesInMethod[index].Value;
                    //Dlubal.RFEM5.Node RfemNodeDlubal = RfemNodes[index].;
                    data.SetNode(RfemNodesInMethod[index]);
                }
        ...
        {
            get { return new Guid("b7f6f101-79fc-4cc6-8482-99e7293be442"); }
        }
    }
}